...
export function Footer() {
  const links = [
    {
      title: "MUSIC",
      items: ["NEW RELEASES", "CHARTS", "GENRES", "REVIEWS", "LISTS"],
    },
    {
      title: "COMMUNITY",
      items: ["FORUMS", "MEMBERS", "COLLECTIONS", "BLOG"],
    },
    {
      title: "COMPANY",
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex gap-4">
              <Link
                href="#"
                className="bg-white text-black p-2 rounded-[4px] hover:translate-x-1 hover:-translate-y-1 transition"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
          ...
          {links.map((column, i) => (
            <div key={i}>
              <h3 className="font-mono text-sm mb-4">{column.title}</h3>
              <ul className="space-y-2">
                {column.items.map((item, j) => (
                  <li key={j}>
                    <Link
                      href="#"
                      className="hover:text-[#FF3B3B] font-bold transition"
                    >
                      {item}
                    </Link>
                  </li>
